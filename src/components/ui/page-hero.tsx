...
export function PageHero({ title, description, eyebrow, breadcrumbs, meta, align = "left" }: PageHeroProps) {
  return (
    <section className="relative overflow-hidden hero-bg text-white">
      ...
      />
      <div className={`relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20 ${align === "center" ? "text-center" : ""}`}>
