          ...
          <div className="grid lg:grid-cols-12 gap-10">
            ...
            <aside className="lg:col-span-4 space-y-6">
              <div className="surface p-6">
                <p className="text-[11px] tracking-wider uppercase text-muted-foreground">Coverage</p>
                <h3 className="font-display text-lg font-semibold mt-1">What we research</h3>
                <ul className="mt-4 space-y-2 text-sm text-muted-foreground">
                  {["GDP & growth", "Inflation & RBI policy", "Banking & credit", "Equity & debt markets", "FX & external sector", "Sector deep-dives"].map((x) => (
                    <li key={x} className="flex items-center gap-2">
                      <span className="h-1 w-1 rounded-full bg-[hsl(var(--brand))]" /> {x}
                    </li>
                  ))}
                </ul>
              </div>
