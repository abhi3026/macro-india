    ...
    <section aria-labelledby="hero-heading" className="relative overflow-hidden hero-bg text-white">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-12">
        <div className="max-w-4xl">
          ...
          <h1
            id="hero-heading"
            className="mt-5 font-display text-4xl sm:text-5xl lg:text-[64px] font-semibold leading-[1.05] tracking-tight"
          >
          ...
          <div className="mt-6">
            <p className="text-[10px] tracking-[0.18em] uppercase text-white/70 mb-2">Trusted data sources</p>
