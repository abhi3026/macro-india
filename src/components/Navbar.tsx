...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 left-0 right-0 z-50 bg-background/80 border-b border-border backdrop-blur-sm transition-all duration-300">
          ...
          <div className="hidden md:flex md:items-center md:space-x-4">
            ...
            <Dialog open={subscribeModalOpen} onOpenChange={setSubscribeModalOpen}>
              <DialogContent className="sm:max-w-md">
                <DialogHeader>
                  <DialogTitle className="text-2xl font-bold text-indianmacro-800 dark:text-white">
