...
const MarketTickerLive = () => {
  ...
  return (
    <div className="w-full bg-indianmacro-100 py-2 relative overflow-hidden border-y border-indianmacro-200">
      <div className="flex items-center absolute right-2 top-1/2 transform -translate-y-1/2 z-10 bg-indianmacro-100 pl-2">
        <button
      ...
      <div className="relative">
        <div className="flex animate-[marquee_50s_linear_infinite] space-x-6">
          {markets.map((market) => {
            const symbolDetails = getSymbolDetails(market.symbol);
            return (
              <div key={market.symbol} className="flex items-center space-x-2 whitespace-nowrap px-3">
